    ...
    return (
        <Box bg="white" px={8} py={16}>
            <Flex align="center" justify="space-between" direction={{ base: "column", md: "row" }}>
                ...
                <Stack spacing={6} maxW="lg" textAlign={{ base: "center", md: "left" }} pl={{ base: 15, md: 15}}>
                    <Heading as="h1" fontSize="120px" color="teal.500" fontWeight="700" lineHeight="100px">
                        Huge Puddle Enterprise
                    </Heading>
